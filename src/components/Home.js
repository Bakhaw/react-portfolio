  ...
  render() {
    return (
      ...
      <div className="col-md-6 presentation">
        ...
        <div>
          <p>
            Je suis Faïssal Hattou, étudiant en développement web à <a className="simplon" href={simplon} target="_blank">Simplon.co </a>
            depuis mai 2017.
            J'aurai fini ma formation le 10 janvier 2018, et j'aimerais poursuivre mon apprentissage.
          </p>
          <p>
